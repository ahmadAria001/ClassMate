...
<div class="w-full">
    <div class="fixed left-0 top-0 z-50">
        <div
            class={twMerge(
                "relative h-screen flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 w-full max-w-[12rem] p-1 shadow-xl shadow-blue-gray-900/5",
            )}
        >
            <div class="mb-2 p-4">
                <h5
            ...
            <nav
                class="flex flex-col gap-1 min-w-5 p-2 font-sans text-base font-normal text-gray-700"
            >
                <div
                    role="button"
                    tabindex="0"
                ...
                <div
                    role="button"
                    tabindex="0"
                    class="flex items-center w-full p-3 rounded-lg text-start leading-tight
                    transition-all hover:bg-blue-50 hover:bg-opacity-80 focus:bg-blue-50
                     focus:bg-opacity-80 active:bg-blue-50 active:bg-opacity-80 hover:text-blue-900
                      focus:text-blue-900 active:text-blue-900 outline-none
                      "
                >
                    <div class="grid place-items-center mr-4">
                        <svg
